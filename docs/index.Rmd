...
- why reduce?
- create project "dimreduction_mod3"
- load Bodenmiller dataset
- run tsne and umap
...
- automated vs manual?
- create project "clustering_mod4"
- load GvHD dataset
- run flowsom tuning 
...
- create project "differential_mod5"
- load bodenmiller dataset
- run diffcyto 
...
- give `bodenmiller` as workflow name
